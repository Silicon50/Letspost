...
from lets_post import app, db, bcrypt, mail
from lets_post.form import RegistrationForm, LoginForm, UpdateAccountForm, PostForm, RequestResetForm, ResetPasswordForm#for forms
